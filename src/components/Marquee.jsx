...
const Marquee = () => {
  ...
  <div className="flex gap-10 overflow-hidden border-y-2 border-zinc-300 whitespace-nowrap">
    <motion.h1 initial={{x:0}} animate={{x:"-100%"}} transition={{ease:"linear",repeat:Infinity,duration:5}} className="text-[22vw] leading-none font-['Founders_Grotesk'] font-semibold uppercase py-10">
      we are ochi
    </motion.h1>
    <motion.h1 initial={{x:0}} animate={{x:"-100%"}} transition={{ease:"linear",repeat:Infinity,duration:5}} className="text-[22vw] leading-none font-['Founders_Grotesk'] font-semibold uppercase py-10">
      we are ochi
